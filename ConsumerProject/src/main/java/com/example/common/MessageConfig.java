...
public class MessageConfig {
    ...
    public static final String URL = "https://api.foodbook.vn/ipos/ws/xpartner/callback/vnpay";
    ...
    public static final String ERR_SAVE_DB = "Can not update request to database";
    ...
    public static final String ERR_HTTP_REQUEST = "HttpClient can not send a post request";
