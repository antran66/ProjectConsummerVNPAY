...
public class ExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(RedisConnectionFailureException.class)
    public ResponseEntity<String> assertionException(final RedisConnectionFailureException e) {
        ...
        return new ResponseEntity<>("Redis not available", HttpStatus.INTERNAL_SERVER_ERROR);
    }
